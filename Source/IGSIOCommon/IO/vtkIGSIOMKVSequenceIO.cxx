...
//----------------------------------------------------------------------------
void vtkIGSIOMKVSequenceIO::SetEncodingFourCC(std::string encodingFourCC)
{
  this->Internal->EncodingFourCC = encodingFourCC;
}

//----------------------------------------------------------------------------
std::string vtkIGSIOMKVSequenceIO::GetEncodingFourCC()
{
...
//---------------------------------------------------------------------------
vtkSmartPointer<vtkUnsignedCharArray> vtkIGSIOMKVSequenceIO::vtkInternal::EncodeFrame(vtkImageData* inputFrame, unsigned long &size, int &frameType)
{
...
//----------------------------------------------------------------------------
igtl::GenericEncoder::Pointer vtkIGSIOMKVSequenceIO::vtkInternal::GetEncoderFromFourCC(std::string fourCC)
{
  if (fourCC == "I420")
  {
...
//----------------------------------------------------------------------------
igtl::GenericDecoder::Pointer vtkIGSIOMKVSequenceIO::vtkInternal::GetDecoderFromFourCC(std::string fourCC)
{
  if (fourCC == "I420")
  {
...
//----------------------------------------------------------------------------
bool vtkIGSIOMKVSequenceIO::vtkInternal::FourCCRequiresEncoding(std::string fourCC)
{
  if (fourCC == "RV24")
  {
    return false;
