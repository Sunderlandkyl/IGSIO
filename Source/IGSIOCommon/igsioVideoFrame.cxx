...
igsioVideoFrame& igsioVideoFrame::operator=(igsioVideoFrame const& videoItem)
{
  ...
  this->CompressedFrameData = videoItem.CompressedFrameData;
  this->FrameType = videoItem.FrameType;
...
//----------------------------------------------------------------------------
void igsioVideoFrame::SetUseCompression(bool useCompression)
{
  this->UseCompression = useCompression;
}

//----------------------------------------------------------------------------
bool igsioVideoFrame::GetUseCompression()
{
  return this->UseCompression;
}

//----------------------------------------------------------------------------
bool igsioVideoFrame::IsKeyFrame()
{
  return this->FrameType == FRAME_TYPE_IFRAME;
}
...
//----------------------------------------------------------------------------
int igsioVideoFrame::GetFrameType()
{
...
////----------------------------------------------------------------------------
//igsioCommon::VTKScalarPixelType igsioVideoFrame::GetVTKScalarPixelType(igsioCommon::ITKScalarPixelType pixelType)
//{
//  switch (pixelType)
//  {
...
//----------------------------------------------------------------------------
vtkUnsignedCharArray* igsioVideoFrame::GetCompressedFrameData() const
{
  return this->CompressedFrameData;
}

//----------------------------------------------------------------------------
void igsioVideoFrame::SetCompressedFrameData(vtkUnsignedCharArray* compressedImage)
{
  this->CompressedFrameData = compressedImage;
}
